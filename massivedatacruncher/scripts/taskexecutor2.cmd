...
"%MDC_JAVA_HOME%\bin\java" %DEBUGCONFIG% %CLASSPATH% %GCCONFIG% -Djava.net.preferIPv4Stack=true com.github.mdc.tasks.executor.MassiveDataTaskExecutorDeamon
