...
java --enable-preview -classpath ".:../lib/*:../modules/*" -Xms256M -Xmx256M $GCCCONFIG -Djava.net.preferIPv4Stack=true com.github.mdc.tasks.scheduler.MassiveDataTaskSubmitter "$@"