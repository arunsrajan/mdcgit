...
"%MDC_JAVA_HOME%\bin\java" --enable-preview -Xms2G -Xmx2G %GCCONFIG% %DEBUGCONFIG% %CLASSPATH% -Djava.net.preferIPv4Stack=true com.github.mdc.stream.scheduler.MassiveDataStreamTaskSchedulerDaemon
