...
"%MDC_JAVA_HOME%\bin\java" --enable-preview %CLASSPATH% %MEMCONFIG% %GCCCONFIG% -Djava.net.preferIPv4Stack=true com.github.mdc.tasks.scheduler.MassiveDataTaskSubmitter %*
