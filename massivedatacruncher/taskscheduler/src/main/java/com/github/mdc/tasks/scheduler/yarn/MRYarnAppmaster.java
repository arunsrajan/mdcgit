 ...
 */
public class MRYarnAppmaster extends StaticEventingAppmaster implements ContainerLauncherInterceptor {

	private static final Log log = LogFactory.getLog(MRYarnAppmaster.class);
	...
	public void submitApplication() {
		...
		var appmasterservice = (MRYarnAppmasterService) getAppmasterService();
	...
	public void reportJobStatus(Reducer r, boolean success,String containerid) {
		try {
			lock.acquire();
			if (success) {
