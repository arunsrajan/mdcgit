...
import com.github.mdc.common.MassiveDataTaskSchedulerThreadReducerMBean;
import com.github.mdc.common.ReducerValues;
import com.github.mdc.common.Utils;

@SuppressWarnings("rawtypes")
public class MassiveDataTaskSchedulerThreadReducer
		implements MassiveDataTaskSchedulerThreadReducerMBean, Callable<Context> {
	private static Logger log = Logger.getLogger(MassiveDataTaskSchedulerThreadReducer.class);
	ReducerValues rv;
	String hp;
	...
	public MassiveDataTaskSchedulerThreadReducer(String currentexecutor, ReducerValues rv, String applicationid, String taskid2,
