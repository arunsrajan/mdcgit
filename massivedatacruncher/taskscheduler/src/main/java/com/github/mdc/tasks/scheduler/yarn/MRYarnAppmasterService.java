 ...
 */
public class MRYarnAppmasterService extends MindAppmasterService {

	private static final Log log = LogFactory.getLog(MRYarnAppmasterService.class);

	
	private MRYarnAppmaster yarnAppMaster;
	...
	public MRYarnAppmaster getYarnAppMaster() {
		return yarnAppMaster;
	}

	public void setYarnAppMaster(MRYarnAppmaster yarnAppMaster) {
