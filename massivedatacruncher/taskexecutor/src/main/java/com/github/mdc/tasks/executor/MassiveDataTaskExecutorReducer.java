...
public class MassiveDataTaskExecutorReducer implements Runnable{
	static Logger log = Logger.getLogger(MassiveDataTaskExecutorReducer.class);
	@SuppressWarnings("rawtypes")
	CrunchReducer cr = null;
	ReducerValues rv;
	File file;
	@SuppressWarnings("rawtypes")
	Context ctx;
	...
	int port;
	@SuppressWarnings({ "rawtypes" })
	public MassiveDataTaskExecutorReducer(ReducerValues rv,String applicationid, String taskid,
		...
		try {
			...
			cr = (CrunchReducer) clz.newInstance();
