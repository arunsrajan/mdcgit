...
public class MassiveDataPipelineJsonTest extends MassiveDataPipelineBaseTestClassCommon {
	boolean toexecute = true;
	Logger log = Logger.getLogger(MassiveDataPipelineDepth2Test.class);
	int sum = 0;
	...
	public void testFilterJsonCollect() throws Throwable {
		...
		JsonStream<JSONObject> datapipeline = MassiveDataPipeline.newJsonStreamHDFS(hdfsfilepath,
	...
	public void testFilterMapWithTupleObjectJsonUnionCollect() throws Throwable {
		...
		JsonStream<JSONObject> datapipeline = MassiveDataPipeline.newJsonStreamHDFS(hdfsfilepath,
				githubevents, pipelineconfig);
		MassiveDataPipeline<Tuple2<String,Long>> mdp1 = (MassiveDataPipeline<Tuple2<String,Long>>) datapipeline
				.filter(jsonobj->jsonobj!=null)
				.map(json->new Tuple2<>((String)json.get("type"),1l));
		
		MassiveDataPipeline<Tuple2<String,Long>> mdp2 = (MassiveDataPipeline<Tuple2<String,Long>>) datapipeline
				.filter(jsonobj->jsonobj!=null)
	...
	public void testFilterMapJsonUnionIntersectionCollect() throws Throwable {
		...
		MassiveDataPipeline<Tuple2<String,Long>> mdp3 = (MassiveDataPipeline<Tuple2<String,Long>>) datapipeline
				.filter(jsonobj->jsonobj!=null)
	...
	public void testFilterMapJsonUnionIntersectionUnionCollect() throws Throwable {
		...
		MassiveDataPipeline<Tuple2<String,Long>> mdp4 = (MassiveDataPipeline<Tuple2<String,Long>>) datapipeline
				.filter(jsonobj->jsonobj!=null)
				.map(json->new Tuple2<>((String)json.get("type"),1l));
	...
	public void testFilterJsonUnionSortedAscCollect() throws Throwable {
		...
		JsonStream<JSONObject> datapipeline = MassiveDataPipeline.newJsonStreamHDFS(hdfsfilepath, githubevents,
				pipelineconfig);
		MassiveDataPipeline<JSONObject> mdp1 = (MassiveDataPipeline<JSONObject>) datapipeline
				.filter(jsonobj -> jsonobj != null);

		MassiveDataPipeline<JSONObject> mdp2 = (MassiveDataPipeline<JSONObject>) datapipeline
