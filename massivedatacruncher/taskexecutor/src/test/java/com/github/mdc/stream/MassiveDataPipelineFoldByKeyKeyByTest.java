...
public class MassiveDataPipelineFoldByKeyKeyByTest extends MassiveDataPipelineBaseTestClassCommon {
	...
	public void testFoldByKey() throws Throwable {		
		...
		Long foldValue = 0l;
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample, pipelineconfig);
	...
	public void testKeyBy() throws Throwable {		
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, wordcount, pipelineconfig);
