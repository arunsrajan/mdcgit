...
public class MassiveDataPipelineContinuedTest extends MassiveDataPipelineBaseTestClassCommon {
	...
	public void testFilterCount() throws Throwable {
		...
		List<List<Long>> filterresult = (List) datastream
				.filter(dat -> dat.split(",")[1].equals("1") || dat.split(",")[1].equals("11")).count(null);
	...
	public void testFilterCountPartitioned() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		List<List<Long>> filterresult = (List) datastream
				.filter(dat -> dat.split(",")[1].equals("1") || dat.split(",")[1].equals("11"))
	...
	public void testFilterForEach() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		datastream.filter(dat -> dat.split(",")[3].equals("1")).forEach(System.out::println, new NumPartitions(4));
	...
	public void testFilterForEachPeek() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		datastream.filter(dat -> dat.split(",")[3].equals("1")).peek(val->System.out.println(val)).forEach(System.out::println,
				new NumPartitions(4));
	...
	public void testFilterPartitioned() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		List<List> resultleft = (List) datastream.filter(dat -> dat.split(",")[2].equals("21")).collect(toexecute,
				null);
		List<List> resultright = (List) datastream.filter(dat -> dat.split(",")[2].equals("21")).collect(toexecute,
				new NumPartitions(3));
	...
	public void testFilterSortedPartitioned() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		MassiveDataPipeline map = datastream.filter(dat -> {
			String[] val = dat.split(",");
	...
	public void testForEachMap() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		MassiveDataPipeline<Object> map = datastream.map(dat -> dat.split(","));
	...
	public void testMapFilterSortedPartitioned() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		MassiveDataPipeline map = datastream.map(dat -> dat.split(",")).filter(dat -> !dat[14].equals("ArrDelay"))
				.sorted((val1, val2) -> {
	...
	public void testMassiveDataPipelineSorted() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesamplenoheader,
				pipelineconfig);
	...
	public void testMassiveDataPipelineSortedPartitioned() throws Throwable {
		...
		MassiveDataPipeline<String> datastream = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinenoheader,
				pipelineconfig);
	...
	public void testMultipleDAGNoExecute() throws Throwable {
		...
		MassiveDataPipeline<Object> map1 = map.map(datas -> datas[0] + "" + datas[14]);
	...
	public void testMultipleDAGPartitioned() throws Throwable {
		...
		MassiveDataPipeline<String[]> map = datastream.map(dat -> dat.split(","));
		MassiveDataPipeline<Object> map1 = map.map(datas -> datas[0] + "" + datas[14]);
		MassiveDataPipeline<Object> map2 = map.map(datas -> datas[1] + "" + datas[14]);
		MassiveDataPipeline<Object> map3 = map.map(datas -> datas[2] + "" + datas[14]);
		MassiveDataPipeline<Object> map4 = map.map(datas -> datas[3] + datas[14]);
