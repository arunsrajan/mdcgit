...
public class MassiveDataPipelineSummaryStatisticsTest extends MassiveDataPipelineBaseTestClassCommon {

	Logger log = Logger.getLogger(MassiveDataPipelineSummaryStatisticsTest.class);
	...
	public void testSummaryStatistics() throws Throwable {
		...
		List<List<IntSummaryStatistics>> summarylist = (List) datastream.map(str -> str.split(","))
				.filter(str -> !str[14].equals("ArrDelay")&&!str[14].equals("NA")).mapToInt(str->Integer.parseInt(str[14])).summaryStatistics();
	...
	public void testSum() throws Throwable {
		...
		List<List<Integer>> suml = (List) datastream.map(str -> str.split(","))
				.filter(str -> !str[14].equals("ArrDelay")&&!str[14].equals("NA")).mapToInt(str->Integer.parseInt(str[14])).sum();
	...
	public void testMax() throws Throwable {
		...
		List<List<Integer>> maxl = (List) datastream.map(str -> str.split(","))
				.filter(str -> !str[14].equals("ArrDelay")&&!str[14].equals("NA")).mapToInt(str->Integer.parseInt(str[14])).max();
	...
	public void testMin() throws Throwable {
		...
		List<List<Integer>> minl = (List) datastream.map(str -> str.split(","))
				.filter(str -> !str[14].equals("ArrDelay")&&!str[14].equals("NA")).mapToInt(str->Integer.parseInt(str[14])).min();
	...
	public void testStandardDeviation() throws Throwable {
		...
		List<List<Double>> stdl = (List) datastream.map(str -> str.split(","))
				.filter(str -> !str[14].equals("ArrDelay")&&!str[14].equals("NA")).mapToInt(str->Integer.parseInt(str[14])).standardDeviation();
