...
public class MassiveDataPipelineTransformationsSaveToFileTest extends MassiveDataPipelineBaseTestClassCommon {
	...
	public void testPipelineMap() throws Exception {
		MassiveDataPipeline<String> pipeline = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
	...
	public void testPipelineFlatMap() throws Exception {
		MassiveDataPipeline<String> pipeline = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, wordcount,
				pipelineconfig);
	...
	public void testUnionFilter() throws Exception {
		...
		MassiveDataPipeline<String> datastream1 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airline1987,
				pipelineconfig);
		MassiveDataPipeline<String> datastream2 = MassiveDataPipeline
				.newStreamHDFS(hdfsfilepath, airlinesamplejoin, pipelineconfig)
				.filter(val -> val.split(MDCConstants.COMMA)[2].equals("2")
						|| val.split(MDCConstants.COMMA)[2].equals("3")
						|| val.split(MDCConstants.COMMA)[2].equals("4"));
