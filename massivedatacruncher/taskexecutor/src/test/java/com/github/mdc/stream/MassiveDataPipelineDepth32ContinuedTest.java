...
public class MassiveDataPipelineDepth32ContinuedTest extends MassiveDataPipelineBaseTestClassCommon {
	boolean toexecute = true;
	Logger log = Logger.getLogger(MassiveDataPipelineDepth32ContinuedTest.class);
	int sum = 0;
