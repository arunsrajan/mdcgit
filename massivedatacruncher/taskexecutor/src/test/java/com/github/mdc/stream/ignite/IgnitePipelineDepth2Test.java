...
public class IgnitePipelineDepth2Test extends StreamPipelineIgniteBase {
  ...
  public void testFilterFilterSaveToHdfs() throws Throwable {
    ...
    IgnitePipeline<String> datapipeline =
        IgnitePipeline.newStreamHDFS(hdfsfilepath, airlinesample, pipelineconfig);
    datapipeline
    ...
    List<List> data = (List) datapipeline
        .filter(new com.github.mdc.common.functions.PredicateSerializable<java.lang.String>() {
          public boolean test(java.lang.String value) {
            ...
            new com.github.mdc.common.functions.FlatMapFunction<java.lang.String, java.lang.String>() {
    ...
    List<List> data = (List) datapipeline
        .filter(new com.github.mdc.common.functions.PredicateSerializable<java.lang.String>() {
          public boolean test(java.lang.String value) {
            ...
            new com.github.mdc.common.functions.MapFunction<java.lang.String, java.lang.String[]>() {
    ...
    List<List> data = (List) datapipeline.mapToPair(
        new com.github.mdc.common.functions.MapToPairFunction<java.lang.String, org.jooq.lambda.tuple.Tuple2<java.lang.String, java.lang.String>>() {
          public org.jooq.lambda.tuple.Tuple2 apply(java.lang.String value) {
            ...
            new com.github.mdc.common.functions.PredicateSerializable<org.jooq.lambda.tuple.Tuple2>() {
    ...
    List<List<Tuple2>> data = (List) datapipeline.mapToPair(
        new com.github.mdc.common.functions.MapToPairFunction<java.lang.String, org.jooq.lambda.tuple.Tuple2<java.lang.String, java.lang.String>>() {
          public org.jooq.lambda.tuple.Tuple2 apply(java.lang.String value) {
            ...
            new com.github.mdc.common.functions.SortedComparator<org.jooq.lambda.tuple.Tuple2>() {
              public int compare(org.jooq.lambda.tuple.Tuple2 value1,
                  org.jooq.lambda.tuple.Tuple2 value2) {
                return value1.compareTo(value2);
              }
            })
        .collect(toexecute, null);
  ...
  public void testSortedFilterForEach() throws Throwable {
    ...
    IgnitePipeline<String> datapipeline =
        IgnitePipeline.newStreamHDFS(hdfsfilepath, airlinesample, pipelineconfig);
    sum = 0;
    datapipeline.sorted(new com.github.mdc.common.functions.SortedComparator<java.lang.String>() {
      public int compare(java.lang.String value1, java.lang.String value2) {
        return value1.compareTo(value2);
      }
    }).filter(new com.github.mdc.common.functions.PredicateSerializable<java.lang.String>() {
