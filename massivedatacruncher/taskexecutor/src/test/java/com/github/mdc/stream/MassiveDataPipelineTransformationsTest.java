...
public class MassiveDataPipelineTransformationsTest extends MassiveDataPipelineBaseTestClassCommon {
	...
	public void testPipelineMap() throws Exception{
		MassiveDataPipeline<String> pipeline = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample, pipelineconfig);
		MassiveDataPipeline<String[]> map = pipeline.map(dat->dat.split(","));
	...
	public void testPipelineFlatMap() throws Exception{
		MassiveDataPipeline<String> pipeline = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, wordcount, pipelineconfig);
		MassiveDataPipeline<String> flatmap = pipeline.flatMap(dat->Arrays.asList(dat.split(" ")));
	...
	public void testFilter() throws Exception {
		...
		long count = linereader.lines().count();
		linereader.close();
		List<List<String>> data=datastream.filter(val->val.split(MDCConstants.COMMA)[0].equals("2007")||val.split(MDCConstants.COMMA)[0].equalsIgnoreCase("Year")).collect(toexecute, null);
		long sum = 0;
		for(int index=0;index<data.size();index++) {
			sum+=data.get(index).size();
		}
	...
	public void testLeftOuterJoin() throws Exception {
		...
		String local = pipelineconfig.getLocal();
		pipelineconfig.setLocal("true");
		MassiveDataPipeline<String> datastream1 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		MassiveDataPipeline<String> datastream2 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		LineNumberReader linereader = new LineNumberReader(new InputStreamReader(new FileInputStream("src/test/resources/airlinesample.csv")));
		long count = linereader.lines().count();
		linereader.close();
	...
	public void testLeftOuterJoinFilter() throws Exception {
		...
		pipelineconfig.setLocal("true");
		MassiveDataPipeline<String> datastream1 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig).filter(val->val.split(MDCConstants.COMMA)[1].equals("1"));
		MassiveDataPipeline<String> datastream2 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample,
				pipelineconfig);
		List<List<String>> data=datastream1.leftOuterjoin(datastream2, (val1,val2)->val1.equals(val2)).collect(toexecute, null);
		long sum = 0;
	...
	public void testJoin() throws Exception {
		...
		String local = pipelineconfig.getLocal();
		pipelineconfig.setLocal("true");
		MassiveDataPipeline<String> datastream1 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesamplejoin,
				pipelineconfig);
		MassiveDataPipeline<String> datastream2 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesamplejoin,
				pipelineconfig);
	...
	public void testJoinFilter() throws Exception {
		...
		pipelineconfig.setLocal("true");
		MassiveDataPipeline<String> datastream1 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesamplejoin,
				pipelineconfig).filter(val->val.split(MDCConstants.COMMA)[2].equals("2")
	...
	public void testUnion() throws Exception {
		...
		linereader2.close();
		MassiveDataPipeline<String> datastream1 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airline1987,
				pipelineconfig);
		MassiveDataPipeline<String> datastream2 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesamplejoin,
				pipelineconfig);
	...
	public void testFilterSorted() throws Exception {
		...
		MassiveDataPipeline<String> datastream1 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesamplejoin,
				pipelineconfig);
		List<List<String>> datas=datastream1.filter(value->!value.split(MDCConstants.COMMA)[2].equals("DayofMonth")).sorted((val1,val2)->{
	...
	public void testMapFilterMapPairCogroup() throws Exception {
		...
		String local = pipelineconfig.getLocal();
		pipelineconfig.setLocal("true");
		MassiveDataPipeline<String[]> datastream1 = MassiveDataPipeline
		...
		MapPair<String, Long> data2 = MassiveDataPipeline.newStreamHDFS(hdfsfilepath, airlinesample, pipelineconfig)
