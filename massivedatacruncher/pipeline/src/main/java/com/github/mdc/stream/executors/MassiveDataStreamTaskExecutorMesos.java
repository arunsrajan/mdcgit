 ...
 * Mesos task executor.
 */
public final class MassiveDataStreamTaskExecutorMesos extends MassiveDataStreamTaskDExecutor {
	private ExecutorDriver driver;
	TaskID taskid;
	private static Logger log = Logger.getLogger(MassiveDataStreamTaskExecutorMesos.class);
	public MassiveDataStreamTaskExecutorMesos(JobStage jobstage,ExecutorDriver driver,
			TaskID taskid) {
		super(jobstage,null);
		this.driver = driver;
		this.taskid = taskid;
