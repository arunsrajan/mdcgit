...
public final class MassiveDataStreamTaskExecutorInMemoryDisk extends MassiveDataStreamTaskExecutorInMemory {
	private static Logger log = Logger.getLogger(MassiveDataStreamTaskExecutorInMemoryDisk.class);
	...
	@Override
	public MassiveDataStreamTaskExecutorInMemoryDisk call() {
