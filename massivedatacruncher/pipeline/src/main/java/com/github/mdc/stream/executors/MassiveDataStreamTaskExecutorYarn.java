 ...
 */
public final class MassiveDataStreamTaskExecutorYarn extends MassiveDataStreamTaskDExecutor {
	private static final Log log = LogFactory.getLog(MassiveDataStreamTaskExecutorYarn.class);
	private String hdfsnn;
	public MassiveDataStreamTaskExecutorYarn(String hdfsnn,JobStage jobstage) {
		super(jobstage, null);
		this.hdfsnn = hdfsnn;
	}
	/**
