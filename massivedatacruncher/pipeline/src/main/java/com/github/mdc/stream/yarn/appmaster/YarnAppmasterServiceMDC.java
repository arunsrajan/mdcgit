 ...
 */
public class YarnAppmasterServiceMDC extends MindAppmasterService {

	private static final Log log = LogFactory.getLog(YarnAppmasterServiceMDC.class);

	
	private YarnAppmasterMDC yarnAppMaster;
	...
	public YarnAppmasterMDC getYarnAppMaster() {
		return yarnAppMaster;
	}

	public void setYarnAppMaster(YarnAppmasterMDC yarnAppMaster) {
