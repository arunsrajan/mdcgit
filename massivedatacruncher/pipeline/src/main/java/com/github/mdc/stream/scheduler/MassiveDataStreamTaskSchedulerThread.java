...
import com.github.mdc.common.MassiveDataStreamTaskSchedulerThreadMBean;
 ...
 */
public class MassiveDataStreamTaskSchedulerThread implements MassiveDataStreamTaskSchedulerThreadMBean,Callable<Object> {

	static Logger log = Logger.getLogger(MassiveDataStreamTaskSchedulerThread.class);
	private int level;
	private Task task;
	private String hp;
	...
	public MassiveDataStreamTaskSchedulerThread(Task task,String hp) {
		this.task= task;
		this.hp = hp;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MassiveDataStreamTaskSchedulerThread other = (MassiveDataStreamTaskSchedulerThread) obj;
		if (hp == null) {
			if (other.hp != null)
				return false;
