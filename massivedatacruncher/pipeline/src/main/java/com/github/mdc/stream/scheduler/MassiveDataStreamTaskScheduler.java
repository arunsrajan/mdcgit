 ...
 */
public class MassiveDataStreamTaskScheduler implements Runnable{
	private static Logger log = Logger.getLogger(MassiveDataStreamTaskScheduler.class);
	private byte[] mrjar; 
	private Socket tss;
	private String[] args;
	String filename;
	public MassiveDataStreamTaskScheduler(CuratorFramework cf, String filename, byte[] mrjar,String[] args,
			 Socket tss) {
		this.mrjar = mrjar;
		this.args = args;
		this.tss = tss;
