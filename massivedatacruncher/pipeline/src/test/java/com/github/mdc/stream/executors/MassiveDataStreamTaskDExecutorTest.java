...
public class MassiveDataStreamTaskDExecutorTest extends MDCPipelineTestsCommon {
	...
	public void testProcessBlockHDFSIntersection() throws Exception {
		...
		MassiveDataStreamTaskDExecutor mdstde = new MassiveDataStreamTaskDExecutor(js, MDCCache.get());
		mdstde.setHdfs(hdfs);
