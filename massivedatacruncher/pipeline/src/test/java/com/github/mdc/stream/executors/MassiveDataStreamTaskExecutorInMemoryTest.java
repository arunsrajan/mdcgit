...
public class MassiveDataStreamTaskExecutorInMemoryTest extends MDCPipelineTestsCommon {
	...
	public void testProcessBlockHDFSIntersection() throws Exception {
		...
		MassiveDataStreamTaskExecutorInMemory mdsteim = new MassiveDataStreamTaskExecutorInMemory(js, resultstream,
				MDCCache.get());
