...
import com.github.mdc.stream.MDCPipelineTestsCommon;
...
public class MassiveDataStreamTaskIgniteTest extends MDCPipelineTestsCommon {
	...
	public void testProcessBlockHDFSIntersection() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, task);
		mdsti.setHdfs(hdfs);
	...
	public void testProcessStreamBlockHDFSIntersectionDiff() throws Exception {
		...
		js.stage.tasks.add(function);
		mdsti = new MassiveDataStreamTaskIgnite(js, task);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
	...
	public void testProcessStreamsBlockHDFSIntersectionDiff() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, task1);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>(), filepaths2 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMap() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, filtertask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
	...
	public void testProcessBlockHDFSMapCount() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, calculatecounttask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMapSummaryStatistics() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, sstask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMapMax() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, maxtask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMapMin() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, mintask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMapSum() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, sumtask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMapSD() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, sdtask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMapCSVCount() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, calcultecounttask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessBlockHDFSMapCSVRecordSumaryStatistics() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, summarystaticstask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessStreamBlockHDFSMapCSVMax() throws Exception {
		...
		js.stage.tasks.add(csvint);
		js.stage.tasks.add(new Max());
		mdsti = new MassiveDataStreamTaskIgnite(js, maxtask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		mdsti.processBlockHDFSMap(inputtocount);
	...
	public void testProcessStreamBlockHDFSMapCSVMin() throws Exception {
		...
		js.stage.tasks.add(csvint);
		js.stage.tasks.add(new Min());
		mdsti = new MassiveDataStreamTaskIgnite(js, mintask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		mdsti.processBlockHDFSMap(inputtocount);
	...
	public void testProcessStreamBlockHDFSMapCSVSum() throws Exception {
		...
		js.stage.tasks.add(csvint);
		js.stage.tasks.add(new Sum());
		mdsti = new MassiveDataStreamTaskIgnite(js, sumtask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		mdsti.processBlockHDFSMap(inputtocount);
	...
	public void testProcessStreamBlockHDFSMapCSVSD() throws Exception {
		...
		js.stage.tasks.add(csvint);
		js.stage.tasks.add(new Sum());
		mdsti = new MassiveDataStreamTaskIgnite(js, sdtask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		mdsti.processBlockHDFSMap(inputtocount);
	...
	public void testProcessSampleCount() throws Exception {
		...
		js.stage.tasks.add(filter);
		js.stage.tasks.add(function);
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, counttask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
	...
	public void testProcessJoin() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, reducebykeytask1);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>(), filepaths2 = new ArrayList<>();
		...
		js.stage.tasks.add(pair);
		js.stage.tasks.add(redfunc);
		mdsti = new MassiveDataStreamTaskIgnite(js, reducebykeytask2);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		...
		mdsti = new MassiveDataStreamTaskIgnite(js, jointask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
	...
	public void testProcessGroupByKey() throws Exception {
		...
		MassiveDataStreamTaskIgnite mdsti = new MassiveDataStreamTaskIgnite(js, mappairtask1);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		List<Path> filepaths1 = new ArrayList<>();
		...
		mdsti = new MassiveDataStreamTaskIgnite(js, gbktask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
	...
	public void testProcessFoldRight() throws Exception {
		...
		js.stage.tasks.add(fbk);
		fbktask.input = new Object[] { is1 };
		mdsti = new MassiveDataStreamTaskIgnite(js, fbktask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
		mdsti.processFoldByKeyTuple2();
	...
	public void testProcessCountByKey() throws Exception {
		...
		mdsti = new MassiveDataStreamTaskIgnite(js, cbktask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
	...
	public void testProcessCoalesce() throws Exception {
		...
		RightOuterJoinPredicate<Tuple2<String, Long>, Tuple2<String, Long>> jp = (Tuple2<String, Long> tup1,
				Tuple2<String, Long> tup2) -> tup1.v1.equals(tup2.v1);
		mdsti = new MassiveDataStreamTaskIgnite(js, coalescetask);
		mdsti.setHdfs(hdfs);
		mdsti.ignite = igniteserver;
		mdsti.cache = ignitecache;
