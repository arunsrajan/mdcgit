...
public class StreamReduceRightOuterJoinJGroupsDivided implements Pipeline {
	private Logger log = Logger.getLogger(StreamReduceRightOuterJoinJGroupsDivided.class);
	...
	public void testMassiveDataCollectExampleRightOuterJoin(String[] args, PipelineConfig pipelineconfig)
		...
		log.info("StreamReduceRightOuterJoinJGroups.testMassiveDataCollectExampleRightOuterJoin After---------------------------------------");
	}
}
