...
public class StreamReducePairJoinLocal implements Serializable, Pipeline {
	private static final long serialVersionUID = -7001849661976107123L;
	private Logger log = Logger.getLogger(StreamReducePairJoinLocal.class);
	...
	public void testReduce(String[] args, PipelineConfig pipelineconfig) throws Exception {
		log.info("StreamReducePairJoin.testReduce Before---------------------------------------");
		...
		log.info("StreamReducePairJoin.testReduce After---------------------------------------");
	}
}
