...
public class StreamReducePairRightJoinCoalesceReductionLocal implements Serializable, Pipeline {
	private static final long serialVersionUID = -7001849661976107123L;
	private Logger log = Logger.getLogger(StreamReducePairRightJoinCoalesceReductionLocal.class);
	...
	public void testReduce(String[] args, PipelineConfig pipelineconfig) throws Exception {
		log.info("StreamReducePairRightJoinCoalesceReduction.testReduce Before---------------------------------------");
		...
		log.info("StreamReducePairRightJoinCoalesceReduction.testReduce After---------------------------------------");
	}
}
