...
public class StreamReduceLeftOuterJoinNormalDivided implements Pipeline {
	private Logger log = Logger.getLogger(StreamReduceLeftOuterJoinNormalDivided.class);
