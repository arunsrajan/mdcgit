...
public class StreamReduceLeftOuterJoinYARN implements Pipeline {
	...
	public void testMassiveDataCollectExampleLeftOuterJoin(String[] args, PipelineConfig pipelineconfig)
			throws Exception {
		log.info("StreamReduceLeftOuterJoinYARN.testMassiveDataCollectExampleLeftOuterJoin Before---------------------------------------");
		...
		log.info("StreamReduceLeftOuterJoinYARN.testMassiveDataCollectExampleLeftOuterJoin After---------------------------------------");
	}
}
