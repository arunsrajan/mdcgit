...
public class StreamReducePairMultipleJoinsCoalesceReductionLocal implements Serializable, Pipeline {
	private static final long serialVersionUID = -7001849661976107123L;
	private Logger log = Logger.getLogger(StreamReducePairMultipleJoinsCoalesceReductionLocal.class);
	...
	public void testReduce(String[] args, PipelineConfig pipelineconfig) throws Exception {
		log.info("StreamReducePairMultipleJoins.testReduce Before---------------------------------------");
