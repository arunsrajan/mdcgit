...
public class StreamReduceLeftOuterJoinInMemoryDiskDivided implements Pipeline {
	private Logger log = Logger.getLogger(StreamReduceLeftOuterJoinInMemoryDiskDivided.class);
