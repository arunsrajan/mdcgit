...
public class SqlUniqueCarrierSumCountArrDelayLocal implements Serializable, Pipeline {
	private static final long serialVersionUID = -7001849661976107123L;
	private Logger log = Logger.getLogger(SqlUniqueCarrierSumCountArrDelayLocal.class);
	...
	public void testSql(String[] args, PipelineConfig pipelineconfig) throws Exception {
		log.info("SqlUniqueCarrierSumCountArrDelayLocal.testSql Before---------------------------------------");
		...
		log.info("Sum = " + sum);
		log.info("SqlUniqueCarrierSumCountArrDelayLocal.testSql After---------------------------------------");
	}
}
