...
public class StreamReduceRightOuterJoinInMemoryDiskDivided implements Pipeline {
	private Logger log = Logger.getLogger(StreamReduceRightOuterJoinInMemoryDiskDivided.class);
