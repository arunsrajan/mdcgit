...
public class StreamReduceCoalesceOneLocal implements Serializable, Pipeline {
	private static final long serialVersionUID = -7001849661976107123L;
	private Logger log = Logger.getLogger(StreamReduceCoalesceOneLocal.class);
	...
	public void testReduce(String[] args, PipelineConfig pipelineconfig) throws Exception {
		log.info("StreamReduceCoalesceOne.testReduce Before---------------------------------------");
		...
		log.info("StreamReduceCoalesceOne.testReduce After---------------------------------------");
	}
}
