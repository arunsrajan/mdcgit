...
/**
 * 
 * @author Arun Holds the required constants for the task schedulers, executors, Data replicator,
...
public class MDCConstants {
  ...
  public static final String MESOS_FRAMEWORK_SHADED_JAR_PATH =
      "/opt/mdc/mesos/MassiveDataStream-1.0.0-shaded.jar";
  public static final String MESOS_FRAMEWORK_TASK_EXECUTOR_COMMAND =
      "exec /usr/local/java/jdk-15.0.1/bin/java -Xms3G -Xmx3G -Djava.library.path=/usr/lib64/ -classpath \".:MassiveDataStream-1.0.0-shaded.jar\" com.github.mdc.stream.mesos.executor.MesosExecutor";
