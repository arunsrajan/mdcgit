...
/**
 * 
 * @author Arun The Heartbeat for sending task statuses map reduce frameworks task executors and
 *         task schedulers
 */
public final class HeartBeat implements HeartBeatCloseable {
  ...
  public void start() throws Exception {
    ...
    if (clusterid != null && !clusterid.trim().equals(MDCConstants.EMPTY)) {
      ...
      channel.connect(MDCConstants.TS + MDCConstants.HYPHEN
      ...
      channel.setReceiver(new Receiver() {
        public void receive(Message msg) {
          if (msg.getObject() instanceof ResponseReceived rr
              && (networkaddress + MDCConstants.UNDERSCORE + serverport).equals(rr.getHp())) {
